...
See our [development](development/getting-started.md) guide for further details.

## Sponsoring

Please consider sponsoring this project. Look out for the "Sponsor this project" area on the [PyGithub project page](https://github.com/PyGithub/PyGithub).
