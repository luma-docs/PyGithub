...
This can be used to semi-automate the creation and maintenance of PyGithub classes. This allows for [adding attributes](#automatically-add-attributes-to-pygithub-classes) and [adding methods](#create-a-pygithub-method-from-an-openapi-path) to PyGithub classes, or
[create entire PyGithub classes](#create-a-pygithub-class-from-an-openapi-schema), including preliminary tests.
...
A schema can easily be extracted from the OpenAPI spec as follows (this requires [jq](https://jqlang.github.io/jq/) to be installed):
...
A path can easily be extracted from the OpenAPI spec as follows (this requires [jq](https://jqlang.github.io/jq/) to be installed):
...
when [applying schemas](#automatically-add-attributes-to-pygithub-classes) or [creating methods](#create-a-pygithub-method-from-an-openapi-path).
